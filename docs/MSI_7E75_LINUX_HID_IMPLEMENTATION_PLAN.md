...
- generate the same feature buffers as Phase 0
- print a compact debug view of the final buffers
- compare generated bytes to golden layouts from the static docs
...
- generated bytes match the documented buffer layouts
- dry-run output is useful for review without exposing hardware access
